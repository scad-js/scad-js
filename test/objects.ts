...
describe('Circle', () => {
  it('should create circle with default radius', () => {
    assert.deepEqual(S.circle(), { type: 'circle', params: { r: 1 } });
  });
  it('should create circle with defined radius', () => {
    assert.deepEqual(S.circle(16), { type: 'circle', params: { r: 16 } });
  });
  it('should create circle with defined radius and optional params', () => {
    assert.deepEqual(S.circle(4, { $fn: 6 }), {
      type: 'circle',
      params: { r: 4, $fn: 6 },
    });
    assert.deepEqual(S.circle(2, { $fn: 6, $fa: 5 }), {
      type: 'circle',
      params: { r: 2, $fa: 5, $fn: 6 },
    });
    assert.deepEqual(S.circle(1, { $fn: 6, $fa: 5, $fs: 4 }), {
      type: 'circle',
...
describe('Sphere', () => {
  it('should create a sphere with default radius', () => {
    assert.deepEqual(S.sphere(), { type: 'sphere', params: { r: 1 } });
  });
  it('should create a sphere with a defined radius', () => {
    assert.deepEqual(S.sphere(8), { type: 'sphere', params: { r: 8 } });
    assert.deepEqual(S.sphere(8, { $fn: 4 }), {
      type: 'sphere',
      params: { r: 8, $fn: 4 },
    });
  });
  it('should create a sphere with a defined radius', () => {
    ...
    assert.deepEqual(S.sphere(8, { $fn: 4, $fa: 10 }), {
      type: 'sphere',
      params: { r: 8, $fa: 10, $fn: 4 },
    });
    assert.deepEqual(S.sphere(8, { $fn: 4, $fa: 10, $fs: 2 }), {
      type: 'sphere',
      params: { r: 8, $fa: 10, $fn: 4, $fs: 2 },
    });
    assert.deepEqual(S.sphere(8, { $fn: 0, $fa: 0, $fs: 0 }), {
      type: 'sphere',
