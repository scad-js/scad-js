...
export const circle = (r = 1, params = {}) => object('circle')({
  r,
  ...params,
});

export const square = (size = [1, 1], params = {}) => object('square')({
  size,
  center,
  ...params,
});
...
export const polygon = (points = undef, paths = undef, convexity = 1) => object('polygon')({
  points,
  paths,
  convexity,
});

export const sphere = (r = 1, params = {}) => object('sphere')({
  r,
  ...params,
});

export const cube = (size = [1, 1, 1], params = {}) => object('cube')({
  size,
  center,
  ...params,
});

export const cylinder = (h = 1, r = 1, params = {}) => object('cylinder')({
  h,
...
export const polyhedron = (points = undef, paths = undef, convexity = 1) => object('polyhedron')({
  points,
  paths,
  convexity,
});
